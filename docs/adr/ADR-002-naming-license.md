...
## Context
Need npm name, bin, license, remote policy. Live registry audit 2026-09-24: `archmark`,
`@archmark/cli`, `@archmark/core` all unclaimed (404); github user `archmark` squatted
(canonical home stays `parnish007/archmark`); no live federal software mark found
(quick search only — full clearance before 1.0).
