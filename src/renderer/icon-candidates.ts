...
export const CANDIDATE_A: Record<string, string> = {
  ...
  browser: g(2, 'round', '<rect x="3.5" y="5" width="17" height="14" rx="2"/><path d="M3.5 9h17"/>') + DOT(6.5, 7, 1.1) + DOT(9.0, 7, 1.1),
  mobile: g(2, 'round', '<rect x="8" y="3" width="8" height="18" rx="2"/><path d="M10.5 18h3"/>'),
  ...
  api: g(2, 'round', '<path d="M8 9l-4 3 4 3M16 9l4 3-4 3M13 5l-2 14"/>'),
  gateway: g(2, 'round', '<circle cx="12" cy="12" r="8"/><circle cx="12" cy="12" r="2.2"/><path d="M12 2v2M12 20v2M2 12h2M20 12h2"/>'),
  ...
  worker: g(2, 'round', '<circle cx="12" cy="12" r="2.75"/><path d="M12 2.8v3M12 18.2v3M2.8 12h3M18.2 12h3M6.2 6.2l1.4 1.4M16.4 16.4l1.4 1.4M17.8 6.2l-1.4 1.4M7.6 16.4l-1.4 1.4"/>'),
  ...
  storage: g(2, 'round', '<path d="M4 7l8-3.5L20 7v10l-8 3.5L4 17z"/><path d="M4 12l8 3.5L20 12M12 10.5V20"/>'),
  filesystem: g(2, 'round', '<path d="M4 6h6l2 2h8v10H4z"/>'),
  cloud: g(2, 'round', '<path d="M7 17.5a4 4 0 01-.5-8A5.5 5.5 0 0117.3 8.5 3.5 3.5 0 0117 17.5z"/>'),
  ...
  agent: g(2, 'round', '<circle cx="12" cy="12" r="7.5"/><path d="M9 14.5c1 1 2 1.5 3 1.5s2-.5 3-1.5"/>') + DOT(9.5, 11, 1.4) + DOT(14.5, 11, 1.4),
