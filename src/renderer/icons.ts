...
export const ICONS: Record<string, string> = {
  ...
  queue: wrap(
    '<path d="M4 7h16M4 12h16M4 17h16"/><g stroke="none" fill="currentColor"><circle cx="7" cy="7" r="1.4"/><circle cx="15" cy="12" r="1.4"/><circle cx="10" cy="17" r="1.4"/></g>',
  ),
  gateway: wrap('<circle cx="12" cy="12" r="8"/><circle cx="12" cy="12" r="2.2"/><path d="M12 2v2M12 20v2M2 12h2M20 12h2"/>'),
  worker: wrap(
    '<circle cx="12" cy="12" r="2.75"/><path d="M12 2.8v3M12 18.2v3M2.8 12h3M18.2 12h3M6.2 6.2l1.4 1.4M16.4 16.4l1.4 1.4M17.8 6.2l-1.4 1.4M7.6 16.4l-1.4 1.4"/>',
  ),
  ...
  server: wrap(
    '<rect x="4" y="4" width="16" height="7" rx="1.5"/><rect x="4" y="13" width="16" height="7" rx="1.5"/><g stroke="none" fill="currentColor"><circle cx="7.5" cy="7.5" r="1.2"/><circle cx="7.5" cy="16.5" r="1.2"/></g>',
  ),
