...
- Filesystem writes are confined: README stays in the working directory, generated SVGs
  use an allowlisted bare-filename pattern, writes are atomic (temp + rename).
